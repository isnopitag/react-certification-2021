  ...
  return (
    <>
      <Wrapper >
          {loading && "LOADING..."}
      <Box1>
        <ReturnBtn onClick={handleClick} type="button"><span>Return to main</span></ReturnBtn>
        </Box1>
        <div>
        ...
        <div>
          {items.map((itemVideo) => {
            ...
            return <YoutubeCard key={etag} id={idVideo} item={snippet} setView={setView} setItem={setItem}/>;
          })}
        </div>
      </Wrapper>
    </>
